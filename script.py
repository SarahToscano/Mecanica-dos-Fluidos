...
#R2 = Rectangle(Point(5./8.*L,1./4*H      ), Point(6./8.*L,H))
R3 = Rectangle(Point(2./8.*L,1./4*H      ), Point(3./8.*L,H))
R4 = Rectangle(Point(5./8.*L,0      ), Point(6./8.*L,3./4*H))

#E1 = Circle(Point((6./8.*L,H)), 2./8.*L)
#E2 = Circle(Point((2./8.*L,0)), 2./8.*L)
#E3 = Circle(Point((2./8.*L,1./3*H)), 2./8.*L)
#E4 = Circle(Point((6./8.*L,1./2*H)), 2./8.*L)
